...
func TestComplex64FromComplex64(t *testing.T) {
...
func TestComplex64FromFloat32(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		yi := imag(x)
		if expected, actual := float32(0), yi; expected != actual {
			if !(math.IsNaN(float64(expected)) && math.IsNaN(float64(actual))) {
				t.Errorf("For test #%d, expected %v, but actually got %v.", testNumber, expected, actual)
				continue
			}
...
func TestComplex64FromInt8(t *testing.T) {
...
func TestComplex64FromInt16(t *testing.T) {
...
func TestComplex64FromUint8(t *testing.T) {
...
func TestComplex64FromUint16(t *testing.T) {
